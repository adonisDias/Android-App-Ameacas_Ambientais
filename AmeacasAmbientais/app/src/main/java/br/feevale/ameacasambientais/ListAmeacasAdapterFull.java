...
/**
 * Created by adonis on 22/10/16.
 */
public class ListAmeacasAdapterFull extends BaseAdapter {

    private List<Ameaca> ameacas_ambientais;
    private ListaAmeacasActivity ctx;
    AmeacaDBDAO db;
    public ListAmeacasAdapterFull(ListaAmeacasActivity ctx){
        this.ctx = ctx;
        db = ctx.db;
